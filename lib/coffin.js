...
(function() {
  ...
  CloudFormationTemplateContext = (function() {
    ...
    CloudFormationTemplateContext.prototype.DeclareResource = function(name) {
      var _base;
      return (_base = this.Resources)[name] != null ? _base[name] : _base[name] = {
        Ref: name
      };
    };
    ...
    CloudFormationTemplateContext.prototype._resourceByType = function(type, name, props) {
      var result;
      result = {};
      if (((props != null ? props.Metadata : void 0) != null) || ((props != null ? props.Properties : void 0) != null) || ((props != null ? props.DependsOn : void 0) != null)) {
        result[name] = props;
        result[name].Type = type;
      } else {
        result[name] = {
